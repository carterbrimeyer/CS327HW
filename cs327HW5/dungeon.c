...
void update_ui(dungeon_t *d)
{
    move(21, 0);
    clrtoeol();
    mvprintw(21, 1, "%d known monster(s).", d->num_monsters);
    move(22, 0);
    clrtoeol();
    mvprintw(22, 1, "PC position is (%d, %d).", d->pc.position[dim_x], d->pc.position[dim_y]);
    refresh();
}
